...
"""
@component function RelativeAngleSensor(; name)
  ...
  ### Variables
  __vars = Any[]
  append!(__vars, @variables phi_rel(t), [output = true])
...
export RelativeAngleSensor

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(RelativeAngleSensor)) = print(io,
