...
"""
@component function AccelerationSource(; name)
  ...
  ### Variables
  __vars = Any[]
  append!(__vars, @variables a_ref(t), [input = true])
  append!(__vars, @variables (phi_support(t)), [description = "Absolute angle of support spline"])
  append!(__vars, @variables (phi(t)), [description = "Rotation angle of spline with respect to support"])
  append!(__vars, @variables (w(t)), [description = "Angular velocity of spline with respect to support"])
  append!(__vars, @variables (a(t)), [description = "Angular acceleration of spline with respect to support"])
...
export AccelerationSource

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(AccelerationSource)) = print(io,
