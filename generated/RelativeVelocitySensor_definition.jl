...
"""
@component function RelativeVelocitySensor(; name)
  ...
  ### Variables
  __vars = Any[]
  append!(__vars, @variables w_rel(t), [output = true])
  append!(__vars, @variables (phi_rel(t)), [description = "Relative angle between two splines"])
  ...
  ### Equations
  __eqs = Equation[]
  push!(__eqs, 0 ~ spline_a.tau + spline_b.tau)
  push!(__eqs, phi_rel ~ spline_b.phi - spline_a.phi)
  push!(__eqs, w_rel ~ D(phi_rel))
  push!(__eqs, 0 ~ spline_a.tau)

  # Return completely constructed ODESystem
  return ODESystem(__eqs, t, __vars, __params; systems=__systems, defaults=__defaults, name, initialization_eqs=__initialization_eqs)
end
export RelativeVelocitySensor

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(RelativeVelocitySensor)) = print(io,
