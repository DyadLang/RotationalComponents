...
"""
   SpringDamper(; name, d, c, phi_rel0)
...
"""
@component function SpringDamper(; name, d=nothing, c=nothing, phi_rel0=0)
  ...
  append!(__vars, @variables (tau_c(t)), [description = "Spring torque"])
  append!(__vars, @variables (tau_d(t)), [description = "Damper torque"])
  ...
  push!(__eqs, tau_c ~ c * (phi_rel - phi_rel0))
  push!(__eqs, tau_d ~ d * w_rel)
  push!(__eqs, tau ~ tau_c + tau_d)
