 ...
 * `spline` - ([`Spline`](@ref))
 * `support` - ([`Spline`](@ref))
 * `w_ref` - This connector represents a real signal as an input to a component ([`RealInput`](@ref))
...
"""
@component function SpeedSource(; name)
  ...
  ### Variables
  __vars = Any[]
  append!(__vars, @variables w_ref(t), [input = true])
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(SpeedSource)) = print(io,
