...
"""
@component function TorqueSource(; name)
  ...
  ### Variables
  __vars = Any[]
  append!(__vars, @variables tau(t), [input = true])
  append!(__vars, @variables (phi_support(t)), [description = "Absolute angle of support spline"])
  append!(__vars, @variables (phi(t)), [description = "Angle of spline with respect to support"])
...
Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(TorqueSource)) = print(io,
