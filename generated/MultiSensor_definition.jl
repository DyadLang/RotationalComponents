...
@component function MultiSensor(; name)
  ...
  append!(__vars, @variables tau(t), [output = true])
  append!(__vars, @variables w(t), [output = true])
  ...
  push!(__eqs, spline_a.phi ~ spline_b.phi)
  push!(__eqs, w ~ D(spline_a.phi))
  push!(__eqs, tau ~ spline_a.tau)
  push!(__eqs, power ~ tau * w)
