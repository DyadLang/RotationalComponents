...
"""
@component function VelocitySensor(; name)
  ...
  ### Equations
  __eqs = Equation[]
  push!(__eqs, 0 ~ spline.tau)
  push!(__eqs, w ~ D(spline.phi))

  # Return completely constructed ODESystem
  return ODESystem(__eqs, t, __vars, __params; systems=__systems, defaults=__defaults, name, initialization_eqs=__initialization_eqs)
end
export VelocitySensor

Base.show(io::IO, a::MIME"image/svg+xml", t::typeof(VelocitySensor)) = print(io,
